...
<div class="page-content">
	...
	<p>이 약관은 <?php echo $name_company;?>(전자상거래 사업자로 이하 "회사"라 한다)가 운영하는 <?php echo $name_site;?>(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.</p> 
