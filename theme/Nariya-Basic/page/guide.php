...
<div class="page-content">
	...
	<p>
  	...
  	<div class="article-title">2. 포인트 제도 안내</div>
	...
	<div class="table-responsive">
		...
		<tr class="active">
			...
			<th class="text-center">읽기점수</th>
			<th class="text-center">쓰기점수</th>
			<th class="text-center">댓글점수</th>
			<th class="text-center">다운점수</th>
		</tr>
		<?php
  	...
  	<div class="article-title">3. 게시물 규제정책</div>
