		...
		<div class="item" id="<?php echo substr($list[$i], 0, strrpos($list[$i], '.')) ?>">
			<div class="well well-sm">
				...
				<p class="text-center">
					...
					<a href="./image_delete.php?mode=<?php echo urlencode($mode) ?>&amp;fid=<?php echo urlencode($fid);?>&amp;img=<?php echo urlencode($list[$i]) ?>&amp;win=1" class="btn btn-xs btn-default img-del">
						삭제
					</a>
				</p>
			</div>
...
<div id="fsetup_btn">
	<button type="button" class="btn btn-na-navy btn-block" onclick="self.close();">창닫기</button>
</div>
